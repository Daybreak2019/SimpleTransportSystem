...
Example subscription of type Breakdown automatically generated by 
...
class BreakdownListener : public DDSDataReaderListener {
  public:
...
extern "C" int breakdown_subscriber(int domainId, int sample_count)
{
    DDSDomainParticipant *participant = NULL;
    DDSSubscriber *subscriber = NULL;
    DDSTopic *topic = NULL;
    BreakdownListener *reader_listener = NULL; 
    ...
    reader_listener = new BreakdownListener();
    ...
    for (count=0; (sample_count == 0) || (count < sample_count); ++count) {
        ...
        printf("Breakdown subscriber sleeping for %d sec...\n",
        receive_period.sec);
