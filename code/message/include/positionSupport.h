...
DDS_DATAWRITER_WITH_DATA_CONSTRUCTOR_METHODS_CPP(PositionDataWriter, Position);
#undef ENABLE_TDATAWRITER_DATA_CONSTRUCTOR_METHODS
#define ENABLE_TDATAREADER_DATA_CONSISTENCY_CHECK_METHOD
DDS_DATAREADER_W_DATA_CONSISTENCY_CHECK(PositionDataReader, PositionSeq, Position);
