...
DDS_DATAWRITER_WITH_DATA_CONSTRUCTOR_METHODS_CPP(AccidentDataWriter, Accident);
#undef ENABLE_TDATAWRITER_DATA_CONSTRUCTOR_METHODS
#define ENABLE_TDATAREADER_DATA_CONSISTENCY_CHECK_METHOD
DDS_DATAREADER_W_DATA_CONSISTENCY_CHECK(AccidentDataReader, AccidentSeq, Accident);
