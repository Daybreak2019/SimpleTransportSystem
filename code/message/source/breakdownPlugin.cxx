...
{
    Breakdown *sample = NULL;

    sample = new (std::nothrow) Breakdown ;
    if (sample == NULL) {
        return NULL;
    }

    if (!Breakdown_initialize_w_params(sample,alloc_params)) {
        delete  sample;
        sample=NULL;
    }
    return sample;
...
BreakdownPluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!Breakdown_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        delete  sample;
        sample=NULL;
    }
...
{
    return BreakdownPluginSupport_create_data_ex(RTI_TRUE);
}
...
BreakdownPluginSupport_destroy_data_w_params(
    ...
    Breakdown_finalize_w_params(sample,dealloc_params);
...
BreakdownPluginSupport_destroy_data_ex(
    ...
    Breakdown_finalize_ex(sample,deallocate_pointers);
...
BreakdownPluginSupport_destroy_data(
    ...
    BreakdownPluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
BreakdownPluginSupport_copy_data(
    ...
    const Breakdown *src)
{
    return Breakdown_copy(dst,(const Breakdown*) src);
}
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        BreakdownPluginSupport_create_data,
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = BreakdownPlugin_get_serialized_sample_max_size(
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            BreakdownPlugin_get_serialized_sample_max_size, epd,
...
BreakdownPlugin_return_sample(
    ...
    void *handle)
{
    Breakdown_finalize_optional_members(sample, RTI_TRUE);
    ...
    const Breakdown *src)
{
    ...
    return BreakdownPluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    Breakdown_get_typecode();
    pd.programs = BreakdownPlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
BreakdownPlugin_serialize_to_cdr_buffer(
    ...
    const Breakdown *sample)
{
    return BreakdownPlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!BreakdownPlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
...
RTIBool BreakdownPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    Breakdown **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *BreakdownPlugin_new(void) 
{ 
    ...
    BreakdownPlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    BreakdownPlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    Breakdown_finalize_optional_members;
    ...
    BreakdownPlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    BreakdownPlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    BreakdownPlugin_get_key_kind;
    ...
    */
    ...
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)Breakdown_get_typecode();
    #endif
    ...
    BreakdownPlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    BreakdownPlugin_return_buffer;
    ...
    plugin->endpointTypeName = BreakdownTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

void
BreakdownPlugin_delete(struct PRESTypePlugin *plugin)
{
